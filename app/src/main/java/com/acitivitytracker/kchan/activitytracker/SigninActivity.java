...
import com.acitivitytracker.kchan.activitytracker.ViewModel.SignInActivityViewModel;
...
import static com.acitivitytracker.kchan.activitytracker.Utils.Constants.PERMISSIONS_REQUEST_ENABLE_GPS;
...
public class SigninActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public boolean isServicesOK(){
        ...
        if(available == ConnectionResult.SUCCESS){
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(SigninActivity.this, available, Constants.ERROR_DIALOG_REQUEST);
            dialog.show();
        }else{
